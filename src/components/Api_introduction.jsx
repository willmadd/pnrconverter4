...
const Api_introduction = () => {
  let requestUrl = `https://api.pnrconverter.com`;
  return (
    <div className="blurb api-intro">
      ...
      <h2 className="section-title">An Introduction to the PNR Converter API</h2>
      <p>23 June 2019 Update - Our API is nearly ready, we're just carrying out some final testing. Please contact us via the suggestions page if you would like to be informed when our API is live!</p>
